...
function booksByAuthor(dictionary) {
  ...
  for (authorName in dictionary){
    
    for (bookInfo of  dictionary[authorName]){
      let book = {
        title   : bookInfo[0],
        pages   : bookInfo[1],
        author  : authorName
...
function averagePageCount(booksArray) {
  // Your code here:
  let allBookspageCount = 0;
  
  booksArray.forEach(book => {
    allBookspageCount += book.pages;
  })

  let avgPageCount = allBookspageCount / booksArray.length;
