...
function booksByAuthor(dictionary1) {
  let newArray = [];
  Object.keys(dictionary1).forEach(function(element) {
    dictionary1[element].forEach(function(element2) {
      newArray.push({
        title: element2[0],
        pages: element2[1],
        author: element
...
function createBooks(dictionary1) {
  let newArray = [];
  Object.keys(dictionary1).forEach(function(element) {
    dictionary1[element].forEach(function(element2) {
      newArray.push({
