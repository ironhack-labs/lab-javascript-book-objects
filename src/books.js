...
const booksArray =  [{
 ...
 description: "One of Hemingway's most famous works, it tells the story of Santiago..." }},
  ...
  {title: "The Airbnb Story",
  pages: 256, author: "Leight Gallagher", 
  details: 
  { language: 'English', 
  description: "This is the remarkable behind-the-scenes story of the creation and growth of Airbnb..."}},
 
  {title: "Educated - A Memoir", 
 pages: 352, author: "Tara Westover", 
 details:
 {language: 'English', 
 description: "Educated is an account of the struggle for self-invention..."}},
...
function getBookDetails(book) {
 ...
 bookDetails.pages = book.pages;
 bookDetails.author = book.author;
 return (
  bookDetails.title + " - " + bookDetails.author + " - " + bookDetails.pages + " pages" 
);
}
...
console.log (typeof +Math.ceil((booksArray[i].pages * 500)/90))
console.log (typeof Math.ceil((booksArray[i].pages * 500)/90))
};
