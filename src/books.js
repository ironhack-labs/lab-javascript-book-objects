...
// Your code here:
const booksArray = [{title: "The Old Man and the Sea", pages: 128, author: "Ernest Hemingway", details:{language: "English",description:"One of Hemingway's most famous works, it tells the story of Santiago..."}},
...
function booksByAuthor(dictionary) {
  ...
  dictionary[Keys[i]].forEach((element) =>{
    object.title = element[0]
    object.pages = element[1]
    object.author =Keys[i]
    array.push(object)
  })}
  return array;
}
