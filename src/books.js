...
function getBookDetails(book) {
  ...
  return `${book.title.toString()} - ${book.author.toString()} - ${book.pages} pages`
}
...
function averagePageCount(arrOfBooks) {
  // Your code here
  let sumOfPages = 0;
  arrOfBooks.forEach(book =>{sumOfPages += book.pages})

  return sumOfPages / arrOfBooks.length;
}
