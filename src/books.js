...
booksArray.forEach((element) => {
  ...
  const operation = (element.pages * 500) / 90

  element.readingTime = Math.ceil(operation)
...
function averagePageCount(countPages) {

  let pageCount = 0
  let bookCount = 0

  countPages.forEach((item) => {
...
//  Create a function named averagePageCount() that takes one argument - the books array.The function should return a number representing 
// the average page count of all the books in the array.
