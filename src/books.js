...
// console.log ('readingTime' in booksArray[0])
...
function booksByAuthor(diccionario) {
  let biblioteca = []
  for (let autor in diccionario){
    for (let libro of diccionario[autor]){
      biblioteca.push({title: libro[0], pages: libro[1], author: autor})
    }
  }
  return(biblioteca)
}
