...
booksArray.unshift(book1, book2, book3, book4, book5)
...
function getBookDetails(bookObject) {
  // Your code here:
  const bookString = bookObject.title + " - " + bookObject.author + " - " + bookObject.pages + " pages"
return bookString
}
